...
export default function Footer() {
    return (
        ...
        <div className="bg-black  px-10 flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="flex h-12 w-1/2 divide-x overflow-hidden rounded-lg">
                <code>Made With &hearts; By <Link to={"github.com"}>YourWebDevAnup</Link></code>
            </div>
